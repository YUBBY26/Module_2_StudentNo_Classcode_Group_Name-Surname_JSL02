...
const addNewGoal = () => {
    ...
    const exGoal = goalList.querySelectorAll('li');
    for (const goal of exGoal) {
        if (goal.textContent.trim() === goalInput.trim()) {
            alert('Goal already exists!');
            return document.querySelector('#goalInput').value = '';
        }
    }
if (document.querySelector('#goalInput').value === '') {
